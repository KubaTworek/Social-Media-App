INSERT INTO AuthorPost(Id, firstname, lastname) VALUES (1, 'Jakub', 'Tworek');
...
INSERT INTO MagazinePost(Id, Name) VALUES (1, 'Newsweek');

INSERT INTO ArticlePost(Id, Date, Timestamp, Author_Id, Magazine_Id, Content_Id) VALUES (1, current_date(), CURRENT_TIMESTAMP, 1, 1, 1);
INSERT INTO ArticlePost(Id, Date, Timestamp, Author_Id, Magazine_Id, Content_Id) VALUES (2, current_date(), CURRENT_TIMESTAMP, 1, 1, 2);