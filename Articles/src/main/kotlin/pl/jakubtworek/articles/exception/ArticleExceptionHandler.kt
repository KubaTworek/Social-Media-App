...
class ArticleExceptionHandler {
    ...
    @ExceptionHandler(pl.jakubtworek.articles.exception.ArticleNotFoundException::class)
    ...
    @ExceptionHandler(pl.jakubtworek.articles.exception.UnauthorizedException::class)
